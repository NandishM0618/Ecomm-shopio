      ...
      <div className="flex flex-col items-center p-6 bg-white shadow-md rounded-lg">
        ...
        <div className="flex items-center mb-4 space-x-2">
          <svg
            ...
            height="25"
            fill="currentColor"
            className="bi bi-envelope text-green-500"
            viewBox="0 0 16 16"
          >
        ...
        <div className="flex items-center mb-4 space-x-2">
          <svg
            ...
            height="25"
            fill="currentColor"
            className="bi bi-geo-alt text-gray-700"
            viewBox="0 0 16 16"
          >
        ...
        <div className="flex space-x-4">
          <Link to="#">
            <svg
              ...
              height="40"
              fill="currentColor"
              className="bi bi-facebook pointer text-blue-600"
              viewBox="0 0 16 16"
            >
          ...
          <Link to="#">
            <svg
              ...
              height="40"
              fill="currentColor"
              className="bi bi-youtube pointer text-red-600"
              viewBox="0 0 16 16"
            >
