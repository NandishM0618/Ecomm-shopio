...
export const ALL_RECENT_PRODUCT_REQUEST = "ALL_RECENT_PRODUCT_REQUEST";
export const ALL_RECENT_PRODUCT_SUCCESS = "ALL_RECENT_PRODUCT_SUCCESS";
export const ALL_RECENT_PRODUCT_FAIL = "ALL_RECENT_PRODUCT_FAIL";
